...
; VENTUS-LABEL: fadd:
; VENTUS:       # %bb.0: # %entry
; VENTUS-NEXT:    addi   t0, a0, 4
; VENTUS-NEXT:    lh t1, 0(a0)
; VENTUS-NEXT:    lh t0, 0(t0)
; VENTUS-NEXT:    lw t2, 8(a0)
; VENTUS-NEXT:    fcvt.s.h	t1, t1
; VENTUS-NEXT:    fcvt.s.h	t0, t0
; VENTUS-NEXT:    fadd.s	t0, t1, t0
; VENTUS-NEXT:    fcvt.h.s	t0, t0
...
; VENTUS-NEXT:    lh t2, 0(a0)
; VENTUS-NEXT:    lh t1, 0(t1)
; VENTUS-NEXT:    lh t0, 0(t0)
; VENTUS-NEXT:    lw s1, 12(a0)
; VENTUS-NEXT:    fcvt.s.h	t2, t2
; VENTUS-NEXT:    fcvt.s.h	t1, t1
; VENTUS-NEXT:    fcvt.s.h	t0, t0
; VENTUS-NEXT:    fmadd.s	t0, t2, t0, t1
; VENTUS-NEXT:    fcvt.h.s	t0, t0
